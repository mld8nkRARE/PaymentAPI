...
namespace PaymentAPI.Migrations
{
    ...
    [Migration("20260807215341_AddRefundItems")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentAPI.Domain.Product", b =>
                {
                    ...
                    b.ToTable("products", null, t =>
                        {
                            t.HasCheckConstraint("CK_Products_ReservedQuantity_NonNegative", "\"reserved_quantity\" >= 0");
            ...
            modelBuilder.Entity("PaymentAPI.Infrastructure.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PaymentAPI.Infrastructure.ProcessedDomainEvent", b =>
                {
